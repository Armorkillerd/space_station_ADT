...
ent-ClothingHeadHelmetMakeshift = самодельный стальной шлем
    .desc = Может быть, вообще ничего не носить тоже не плохая идея.
...
ent-ClothingHeadHelmetPaladin = паладинский шлем штеххелм
    .desc = Если кто-то не носит шлем, на войне его неминуемо ждёт смерть, исключений нет.
