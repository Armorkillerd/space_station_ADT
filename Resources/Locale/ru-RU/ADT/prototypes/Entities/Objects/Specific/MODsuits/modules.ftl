...
ent-ADTModsuitModNightVision = модуль ночного зрения
    .desc = В визор костюма вмонтирован ПНВ дисплей. Обычно используется как в гражданских, так и в военных целях и позволяет пользователю воспринимать окружающую обстановку, находясь в полной темноте.

ent-ADTModsuitModStun = модуль оглушения
    .desc = Позволяет вам оглушать врагов ударами кулаков, к сожалению фиксирует ваши руки в форме кулаков при использовании, из-за чего не совместим с приёмами боевых искусств заточенными на ударах.
...
ent-ADTModsuitModWelding = модуль защиты глаз
    .desc = Модуль, установленный в визор костюма. Проецирует перед глазами пользователя поляризованную голографическую пленку. Имеет достаточно высокую защиту от таких экстремальных световых воздействий, как точечная и дуговая сварка, солнечные затмения и ручные фонарики.
...
ent-ADTModsuitModJump = модуль прыжковых ботинок
    .desc = Позволяет вам прыгать на большие расстояния даже в космосе!
...
ent-ADTModsuitModLight = модуль фонарика
    .desc = Встроенный в визор фонарик, что освещает путь!
...
ent-ADTModsuitModStorageSyndie = модуль хранилища синдиката
    .desc = Работает так же как и простой модуль, но делает это намного лучше благодаря манипуляциям с ред спейсом.

ent-ADTModsuitModEmpProtection = модуль ЭМИ защиты
    .desc = Полностью изолирует источник питания от воздействия ЭМИ импульсов, если включен.
