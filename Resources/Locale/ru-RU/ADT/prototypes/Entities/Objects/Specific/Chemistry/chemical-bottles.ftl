...
ent-ADTSilverSulfadiazineChemistryBottle = бутылочка сульфадиазина серебра
    .desc = Бутылочка с сульфадиазином серебра, он оказывает успокаивающий эффект на обожжёную кожу и медленно заживляет физические травмы.
