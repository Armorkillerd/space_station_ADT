...
revolution-toolbox-category-all-hands-master-description =
    ...
    Включает в себя: 2 подозрительных ящика инструментов, прототип
...
revolution-toolbox-category-medrev-description =
    ...
    Набор содержит всё необходимое для организации скрытого медицинского пункта:
...
revolution-toolbox-category-fake-mindshieldrev-description =
    ...
    Включает в себя: 3 батареи гипер ёмкости, 3 глушителя связи,
    10 экстракторов имплантов, 10 имплантеров "фальшивый щит разума".
